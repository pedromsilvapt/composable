...
/**
  ...
  */
export class VideoTestsrc2 extends Filter<VideoTestsrc2Parameters> {
    outputs : FilterStreamRef<VideoTestsrc2Parameters, VideoTestsrc2>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoTestsrc2Parameters = {} as any ) {
        super( inputs, 'testsrc2', parameters );
    }
}

export interface VideoTestsrc2Parameters {
...
/**
  ...
  * The sources accept the following parameters:
  */
export function videoTestsrc2 ( inputs : Stream | Stream[] = [], parameters : VideoTestsrc2Parameters = {} as any ) {
    return new VideoTestsrc2( inputs, parameters );
}