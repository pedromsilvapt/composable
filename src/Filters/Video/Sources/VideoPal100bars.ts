...
/**
  ...
  */
export class VideoPal100bars extends Filter<VideoPal100barsParameters> {
    outputs : FilterStreamRef<VideoPal100barsParameters, VideoPal100bars>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoPal100barsParameters = {} as any ) {
        super( inputs, 'pal100bars', parameters );
    }
}

export interface VideoPal100barsParameters {
...
/**
  ...
  * The sources accept the following parameters:
  */
export function videoPal100bars ( inputs : Stream | Stream[] = [], parameters : VideoPal100barsParameters = {} as any ) {
    return new VideoPal100bars( inputs, parameters );
}