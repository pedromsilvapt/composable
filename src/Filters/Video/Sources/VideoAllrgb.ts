...
/**
  ...
  */
export class VideoAllrgb extends Filter<VideoAllrgbParameters> {
    outputs : FilterStreamRef<VideoAllrgbParameters, VideoAllrgb>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoAllrgbParameters = {} as any ) {
        super( inputs, 'allrgb', parameters );
    }
}

export interface VideoAllrgbParameters {
...
/**
  ...
  * The sources accept the following parameters:
  */
export function videoAllrgb ( inputs : Stream | Stream[] = [], parameters : VideoAllrgbParameters = {} as any ) {
    return new VideoAllrgb( inputs, parameters );
}