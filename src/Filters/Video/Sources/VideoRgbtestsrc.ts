...
/**
  ...
  */
export class VideoRgbtestsrc extends Filter<VideoRgbtestsrcParameters> {
    outputs : FilterStreamRef<VideoRgbtestsrcParameters, VideoRgbtestsrc>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoRgbtestsrcParameters = {} as any ) {
        super( inputs, 'rgbtestsrc', parameters );
    }
}

export interface VideoRgbtestsrcParameters {
...
/**
  ...
  * The sources accept the following parameters:
  */
export function videoRgbtestsrc ( inputs : Stream | Stream[] = [], parameters : VideoRgbtestsrcParameters = {} as any ) {
    return new VideoRgbtestsrc( inputs, parameters );
}