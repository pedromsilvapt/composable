...
/**
  ...
  */
export class VideoTestsrc extends Filter<VideoTestsrcParameters> {
    outputs : FilterStreamRef<VideoTestsrcParameters, VideoTestsrc>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoTestsrcParameters = {} as any ) {
        super( inputs, 'testsrc', parameters );
    }
}

export interface VideoTestsrcParameters {
...
/**
  ...
  * The sources accept the following parameters:
  */
export function videoTestsrc ( inputs : Stream | Stream[] = [], parameters : VideoTestsrcParameters = {} as any ) {
    return new VideoTestsrc( inputs, parameters );
}