...
/**
  ...
  */
export class VideoSmptebars extends Filter<VideoSmptebarsParameters> {
    outputs : FilterStreamRef<VideoSmptebarsParameters, VideoSmptebars>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoSmptebarsParameters = {} as any ) {
        super( inputs, 'smptebars', parameters );
    }
}

export interface VideoSmptebarsParameters {
...
/**
  ...
  * The sources accept the following parameters:
  */
export function videoSmptebars ( inputs : Stream | Stream[] = [], parameters : VideoSmptebarsParameters = {} as any ) {
    return new VideoSmptebars( inputs, parameters );
}