...
/**
  ...
  */
export class VideoPal75bars extends Filter<VideoPal75barsParameters> {
    outputs : FilterStreamRef<VideoPal75barsParameters, VideoPal75bars>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoPal75barsParameters = {} as any ) {
        super( inputs, 'pal75bars', parameters );
    }
}

export interface VideoPal75barsParameters {
...
/**
  ...
  * The sources accept the following parameters:
  */
export function videoPal75bars ( inputs : Stream | Stream[] = [], parameters : VideoPal75barsParameters = {} as any ) {
    return new VideoPal75bars( inputs, parameters );
}