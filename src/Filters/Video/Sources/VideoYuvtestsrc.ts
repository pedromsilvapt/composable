...
/**
  ...
  */
export class VideoYuvtestsrc extends Filter<VideoYuvtestsrcParameters> {
    outputs : FilterStreamRef<VideoYuvtestsrcParameters, VideoYuvtestsrc>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoYuvtestsrcParameters = {} as any ) {
        super( inputs, 'yuvtestsrc', parameters );
    }
}

export interface VideoYuvtestsrcParameters {
...
/**
  ...
  * The sources accept the following parameters:
  */
export function videoYuvtestsrc ( inputs : Stream | Stream[] = [], parameters : VideoYuvtestsrcParameters = {} as any ) {
    return new VideoYuvtestsrc( inputs, parameters );
}