...
/**
  ...
  */
export class VideoColor extends Filter<VideoColorParameters> {
    outputs : FilterStreamRef<VideoColorParameters, VideoColor>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoColorParameters = {} as any ) {
        super( inputs, 'color', parameters );
    }
}

export interface VideoColorParameters {
...
/**
  ...
  * The sources accept the following parameters:
  */
export function videoColor ( inputs : Stream | Stream[] = [], parameters : VideoColorParameters = {} as any ) {
    return new VideoColor( inputs, parameters );
}