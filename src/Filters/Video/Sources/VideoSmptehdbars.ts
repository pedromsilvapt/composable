...
/**
  ...
  */
export class VideoSmptehdbars extends Filter<VideoSmptehdbarsParameters> {
    outputs : FilterStreamRef<VideoSmptehdbarsParameters, VideoSmptehdbars>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoSmptehdbarsParameters = {} as any ) {
        super( inputs, 'smptehdbars', parameters );
    }
}

export interface VideoSmptehdbarsParameters {
...
/**
  ...
  * The sources accept the following parameters:
  */
export function videoSmptehdbars ( inputs : Stream | Stream[] = [], parameters : VideoSmptehdbarsParameters = {} as any ) {
    return new VideoSmptehdbars( inputs, parameters );
}