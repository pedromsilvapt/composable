...
/**
  ...
  */
export class VideoNullsrc extends Filter<VideoNullsrcParameters> {
    outputs : FilterStreamRef<VideoNullsrcParameters, VideoNullsrc>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoNullsrcParameters = {} as any ) {
        super( inputs, 'nullsrc', parameters );
    }
}

export interface VideoNullsrcParameters {
...
/**
  ...
  * The sources accept the following parameters:
  */
export function videoNullsrc ( inputs : Stream | Stream[] = [], parameters : VideoNullsrcParameters = {} as any ) {
    return new VideoNullsrc( inputs, parameters );
}