...
/**
  ...
  */
export class VideoHaldclutsrc extends Filter<VideoHaldclutsrcParameters> {
    outputs : FilterStreamRef<VideoHaldclutsrcParameters, VideoHaldclutsrc>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoHaldclutsrcParameters = {} as any ) {
        super( inputs, 'haldclutsrc', parameters );
    }
}

export interface VideoHaldclutsrcParameters {
...
/**
  ...
  * The sources accept the following parameters:
  */
export function videoHaldclutsrc ( inputs : Stream | Stream[] = [], parameters : VideoHaldclutsrcParameters = {} as any ) {
    return new VideoHaldclutsrc( inputs, parameters );
}