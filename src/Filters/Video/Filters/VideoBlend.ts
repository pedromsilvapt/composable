...
/**
  ...
  */
export class VideoBlend extends Filter<VideoBlendParameters> {
    outputs : FilterStreamRef<VideoBlendParameters, VideoBlend>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoBlendParameters = {} as any ) {
        super( inputs, 'blend', parameters );
    }
}

export interface VideoBlendParameters {
    /**
...
/**
  ...
  * A description of the accepted options follows.
  */
export function videoBlend ( inputs : Stream | Stream[] = [], parameters : VideoBlendParameters = {} as any ) {
    return new VideoBlend( inputs, parameters );
}