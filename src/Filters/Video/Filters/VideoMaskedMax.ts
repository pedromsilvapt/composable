...
/**
  ...
  */
export class VideoMaskedMax extends Filter<VideoMaskedMaxParameters> {
    outputs : FilterStreamRef<VideoMaskedMaxParameters, VideoMaskedMax>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoMaskedMaxParameters = {} as any ) {
        super( inputs, 'maskedmax', parameters );
    }
}

export interface VideoMaskedMaxParameters {
...
/**
  ...
  * This filter accepts the following options:
  */
export function videoMaskedMax ( inputs : Stream | Stream[] = [], parameters : VideoMaskedMaxParameters = {} as any ) {
    return new VideoMaskedMax( inputs, parameters );
}