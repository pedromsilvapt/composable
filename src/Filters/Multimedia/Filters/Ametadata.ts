...
/**
  ...
  */
export class Ametadata extends Filter<AmetadataParameters> {
    outputs : FilterStreamRef<AmetadataParameters, Ametadata>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : AmetadataParameters = {} as any ) {
        super( inputs, 'ametadata', parameters );
    }
}

export interface AmetadataParameters {
    /**
...
/**
  ...
  * This filter accepts the following options:
  */
export function ametadata ( inputs : Stream | Stream[] = [], parameters : AmetadataParameters = {} as any ) {
    return new Ametadata( inputs, parameters );
}