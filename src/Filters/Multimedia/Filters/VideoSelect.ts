...
/**
  ...
  */
export class VideoSelect extends Filter<VideoSelectParameters> {
    outputs : FilterStreamRef<VideoSelectParameters, VideoSelect>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : VideoSelectParameters = {} as any ) {
        super( inputs, 'select', parameters );
    }
}

export interface VideoSelectParameters {
    /**
...
/**
  ...
  * This filter accepts the following options:
  */
export function videoSelect ( inputs : Stream | Stream[] = [], parameters : VideoSelectParameters = {} as any ) {
    return new VideoSelect( inputs, parameters );
}