...
/**
  ...
  */
export class Sendcmd extends Filter<SendcmdParameters> {
    outputs : FilterStreamRef<SendcmdParameters, Sendcmd>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : SendcmdParameters = {} as any ) {
        super( inputs, 'sendcmd', parameters );
    }
}

export interface SendcmdParameters {
    /**
...
/**
  ...
  * These filters accept the following options:
  */
export function sendcmd ( inputs : Stream | Stream[] = [], parameters : SendcmdParameters = {} as any ) {
    return new Sendcmd( inputs, parameters );
}