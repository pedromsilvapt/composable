...
/**
  ...
  */
export class Arealtime extends Filter<ArealtimeParameters> {
    outputs : FilterStreamRef<ArealtimeParameters, Arealtime>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : ArealtimeParameters = {} as any ) {
        super( inputs, 'arealtime', parameters );
    }
}

export interface ArealtimeParameters {
...
/**
  ...
  * They accept the following options:
  */
export function arealtime ( inputs : Stream | Stream[] = [], parameters : ArealtimeParameters = {} as any ) {
    return new Arealtime( inputs, parameters );
}