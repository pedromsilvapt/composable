...
/**
  ...
  */
export class Ainterleave extends Filter<AinterleaveParameters> {
    outputs : FilterStreamRef<AinterleaveParameters, Ainterleave>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : AinterleaveParameters = {} as any ) {
        super( inputs, 'ainterleave', parameters );
    }
}

export interface AinterleaveParameters {
    /**
...
/**
  ...
  * These filters accept the following options:
  */
export function ainterleave ( inputs : Stream | Stream[] = [], parameters : AinterleaveParameters = {} as any ) {
    return new Ainterleave( inputs, parameters );
}