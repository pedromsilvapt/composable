...
/**
  ...
  * MESSAGE is optional.
  */
export class Zmq extends Filter<ZmqParameters> {
    outputs : FilterStreamRef<ZmqParameters, Zmq>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : ZmqParameters = {} as any ) {
        super( inputs, 'zmq', parameters );
    }
}

export interface ZmqParameters {
...
/**
  ...
  * MESSAGE is optional.
  */
export function zmq ( inputs : Stream | Stream[] = [], parameters : ZmqParameters = {} as any ) {
    return new Zmq( inputs, parameters );
}