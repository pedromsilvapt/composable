...
/**
  ...
  */
export class AudioLowPass extends Filter<AudioLowPassParameters> {
    outputs : FilterStreamRef<AudioLowPassParameters, AudioLowPass>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : AudioLowPassParameters = {} as any ) {
        super( inputs, 'lowpass', parameters );
    }
}

export interface AudioLowPassParameters {
    /**
...
/**
  ...
  * The filter accepts the following options:
  */
export function audioLowPass ( inputs : Stream | Stream[] = [], parameters : AudioLowPassParameters = {} as any ) {
    return new AudioLowPass( inputs, parameters );
}