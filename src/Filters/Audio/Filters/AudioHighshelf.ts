...
/**
  ...
  */
export class AudioHighshelf extends Filter<AudioHighshelfParameters> {
    outputs : FilterStreamRef<AudioHighshelfParameters, AudioHighshelf>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : AudioHighshelfParameters = {} as any ) {
        super( inputs, 'highshelf', parameters );
    }
}

export interface AudioHighshelfParameters {
    /**
...
/**
  ...
  * The filter accepts the following options:
  */
export function audioHighshelf ( inputs : Stream | Stream[] = [], parameters : AudioHighshelfParameters = {} as any ) {
    return new AudioHighshelf( inputs, parameters );
}