...
/**
  ...
  */
export class AudioBass extends Filter<AudioBassParameters> {
    outputs : FilterStreamRef<AudioBassParameters, AudioBass>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : AudioBassParameters = {} as any ) {
        super( inputs, 'bass', parameters );
    }
}

export interface AudioBassParameters {
    /**
...
/**
  ...
  * The filter accepts the following options:
  */
export function audioBass ( inputs : Stream | Stream[] = [], parameters : AudioBassParameters = {} as any ) {
    return new AudioBass( inputs, parameters );
}