...
/**
  ...
  */
export class AudioTreble extends Filter<AudioTrebleParameters> {
    outputs : FilterStreamRef<AudioTrebleParameters, AudioTreble>[];

    public constructor ( inputs : Stream | Stream[] = [], parameters : AudioTrebleParameters = {} as any ) {
        super( inputs, 'treble', parameters );
    }
}

export interface AudioTrebleParameters {
    /**
...
/**
  ...
  * The filter accepts the following options:
  */
export function audioTreble ( inputs : Stream | Stream[] = [], parameters : AudioTrebleParameters = {} as any ) {
    return new AudioTreble( inputs, parameters );
}